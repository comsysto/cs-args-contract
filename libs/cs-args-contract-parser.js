    ...
    var result = {
        ...
        parse: function(input, startRule) {
            ...
            function parse_ctor() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, first, rest) {
                        return  {name: 'namedObject', ctorName: [first].concat(rest).join('')};
            ...
            function parse_or() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, left, right) {
                        return {name: 'or', left: left, right: right};
            ...
            function parse_array() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, type) {
                        return {name: 'array', elementType: type};
                    })(pos0, result0[1]);
                }
                if (result0 === null) {
                    pos = pos0;
            ...
            function parse_pair() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, prop, type) {
                        return [prop, type]
                    })(pos0, result0[0], result0[2]);
                }
                if (result0 === null) {
            ...
            function parse_mandatoryParam() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, type) {
                        return {name: 'mandatoryParam', type: type, mandatory: true, optional: false, varargs: false};
                    })(pos0, result0);
                }
                if (result0 === null) {
                    pos = pos0;
            ...
            function parse_varargsParam() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, type) {
                        return {name: 'varargsParam', type: type, mandatory: false, optional: false, varargs: true};
                    })(pos0, result0[0]);
                }
                if (result0 === null) {
                    pos = pos0;
            ...
            function parse_optionalParam() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, type) {
                        return {name: 'optionalParam', type: type, mandatory: false, optional: true, varargs: false};
                    })(pos0, result0[0]);
                }
                if (result0 === null) {
                    pos = pos0;
