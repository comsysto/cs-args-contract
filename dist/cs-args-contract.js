  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_and() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, right) {return {name: 'and', left: left, right: right}; })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_not() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, type) {return {name: 'not', type: type};})(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_bracketed() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, type) { return type; })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
